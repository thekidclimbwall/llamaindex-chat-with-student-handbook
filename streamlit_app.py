...
st.title("Chat with Renting in NYC Copilot")
st.write(
...
if not openai_api_key:
    ...
    if "messages" not in st.session_state.keys():  # Initialize the chat messages history
        st.session_state.messages = [
            {"role": "assistant", "content": "I am Renting in NYC Copilot, your personal assistant. You can ask me about Renting in NYC."}
        ]
